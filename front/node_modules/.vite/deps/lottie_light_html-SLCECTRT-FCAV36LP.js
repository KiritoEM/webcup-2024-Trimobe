...
var Lr = m((Re, ni) => {
  typeof navigator < "u" && function(ye, le) {
        ...
        s || (s = a(function(_) {
          function k() {
            function C(F, m2) {
              ...
              for (o = 0; o < f; o += 1)
                if (S = F[o], "ks" in S && !S.completed) {
                  if (S.completed = true, S.hasMask) {
                    var W = S.masksProperties;
                    for (A = W.length, M = 0; M < A; M += 1)
                      if (W[M].pt.k.i)
                        b(W[M].pt.k);
                      else
                        for (q = W[M].pt.k.length, B = 0; B < q; B += 1)
                          W[M].pt.k[B].s && b(W[M].pt.k[B].s[0]), W[M].pt.k[B].e && b(W[M].pt.k[B].e[0]);
                  }
            ...
            function y(F, m2) {
              if (F) {
                var S = 0, o = F.length;
                for (S = 0; S < o; S += 1)
                  F[S].t === 1 && (F[S].data.layers = p(F[S].data.refId, m2), C(F[S].data.layers, m2));
              }
            }
            function v(F, m2) {
            ...
            function c(F) {
              ...
              for (m2 = S - 1; m2 >= 0; m2 -= 1)
                if (F[m2].ty === "sh")
                  if (F[m2].ks.k.i)
                    b(F[m2].ks.k);
                  else
                    for (f = F[m2].ks.k.length, o = 0; o < f; o += 1)
                      F[m2].ks.k[o].s && b(F[m2].ks.k[o].s[0]), F[m2].ks.k[o].e && b(F[m2].ks.k[o].e[0]);
                else
                  F[m2].ty === "gr" && c(F[m2].it);
            }
            function b(F) {
              var m2, S = F.i.length;
              for (m2 = 0; m2 < S; m2 += 1)
            ...
            var x = /* @__PURE__ */ function() {
              ...
              return function(o) {
                if (P(F, o.v) && (S(o.layers), o.assets)) {
                  ...
                  for (f = 0; f < M; f += 1)
                    o.assets[f].layers && S(o.assets[f].layers);
                }
              };
            }(), T = /* @__PURE__ */ function() {
              var F = [4, 7, 99];
              ...
              function m2(o) {
                ...
                for (f = 0; f < M; f += 1)
                  if (o[f].ty === "gr")
                    ...
                    if (o[f].c.k && o[f].c.k[0].i)
                      for (B = o[f].c.k.length, A = 0; A < B; A += 1)
                        o[f].c.k[A].s && (o[f].c.k[A].s[0] /= 255, o[f].c.k[A].s[1] /= 255, o[f].c.k[A].s[2] /= 255, o[f].c.k[A].s[3] /= 255), o[f].c.k[A].e && (o[f].c.k[A].e[0] /= 255, o[f].c.k[A].e[1] /= 255, o[f].c.k[A].e[2] /= 255, o[f].c.k[A].e[3] /= 255);
                    else
                      o[f].c.k[0] /= 255, o[f].c.k[1] /= 255, o[f].c.k[2] /= 255, o[f].c.k[3] /= 255;
              }
              function S(o) {
                var f, M = o.length;
                for (f = 0; f < M; f += 1)
                  o[f].ty === 4 && m2(o[f].shapes);
              }
              return function(o) {
                if (P(F, o.v) && (S(o.layers), o.assets)) {
                  var f, M = o.assets.length;
              ...
              function m2(o) {
                ...
                for (f = M - 1; f >= 0; f -= 1)
                  if (o[f].ty === "sh")
                    if (o[f].ks.k.i)
                      o[f].ks.k.c = o[f].closed;
                    else
                      for (B = o[f].ks.k.length, A = 0; A < B; A += 1)
                        o[f].ks.k[A].s && (o[f].ks.k[A].s[0].c = o[f].closed), o[f].ks.k[A].e && (o[f].ks.k[A].e[0].c = o[f].closed);
                  else
                    o[f].ty === "gr" && m2(o[f].it);
              }
              function S(o) {
                ...
                for (M = 0; M < A; M += 1) {
                  if (f = o[M], f.hasMask) {
                    ...
                    for (q = Y.length, B = 0; B < q; B += 1)
                      if (Y[B].pt.k.i)
                        Y[B].pt.k.c = Y[B].cl;
                      else
                        for (X = Y[B].pt.k.length, W = 0; W < X; W += 1)
                          Y[B].pt.k[W].s && (Y[B].pt.k[W].s[0].c = Y[B].cl), Y[B].pt.k[W].e && (Y[B].pt.k[W].e[0].c = Y[B].cl);
                  }
                  f.ty === 4 && m2(f.shapes);
                }
              }
          ...
          if (n.dataManager || (n.dataManager = k()), n.assetLoader || (n.assetLoader = /* @__PURE__ */ function() {
            ...
            n.assetLoader.load(_.data.path, _.data.fullPath, function(C) {
            ...
            _.data.type === "loadData" && n.assetLoader.load(_.data.path, _.data.fullPath, function(C) {
    ...
    var Ds = /* @__PURE__ */ function() {
      function t(e) {
        for (var i = e.split(`\r
`), s = {}, r, n = 0, a = 0; a < i.length; a += 1)
          r = i[a].split(":"), r.length === 2 && (s[r[0]] = r[1].trim(), n += 1);
        if (n === 0)
          throw new Error();
        return s;
      }
    ...
    var et = function() {
      ...
      function u(m2) {
        for (var S = 0, o = m2.target; S < s; )
          e[S].animation === o && (e.splice(S, 1), S -= 1, s -= 1, o.isPaused || E()), S += 1;
      }
      function h(m2, S) {
        if (!m2)
          return null;
        for (var o = 0; o < s; ) {
          if (e[o].elem === m2 && e[o].elem !== null)
      ...
      function k(m2, S) {
        var o;
        for (o = 0; o < s; o += 1)
          e[o].animation.setSpeed(m2, S);
      }
      function w(m2, S) {
        var o;
        for (o = 0; o < s; o += 1)
          e[o].animation.setDirection(m2, S);
      }
      function C(m2) {
        var S;
        for (S = 0; S < s; S += 1)
          e[S].animation.play(m2);
      }
      function y(m2) {
        var S = m2 - i, o;
        for (o = 0; o < s; o += 1)
          e[o].animation.advanceTime(S);
      ...
      function p(m2) {
        var S;
        for (S = 0; S < s; S += 1)
          e[S].animation.pause(m2);
      }
      function c(m2, S, o) {
        var f;
        for (f = 0; f < s; f += 1)
          e[f].animation.goToAndStop(m2, S, o);
      }
      function b(m2) {
        var S;
        for (S = 0; S < s; S += 1)
          e[S].animation.stop(m2);
      }
      function P(m2) {
        var S;
        for (S = 0; S < s; S += 1)
          e[S].animation.togglePause(m2);
      }
      function x(m2) {
        var S;
        for (S = s - 1; S >= 0; S -= 1)
          e[S].animation.destroy(m2);
      }
      function T(m2, S, o) {
        ...
        for (M = 0; M < A; M += 1)
          o && f[M].setAttribute("data-bm-type", o), h(f[M], m2);
        if (S && A === 0) {
          o || (o = "svg");
      ...
      function G(m2, S) {
        var o;
        for (o = 0; o < s; o += 1)
          e[o].animation.setVolume(m2, S);
      }
      function R(m2) {
        var S;
        for (S = 0; S < s; S += 1)
          e[S].animation.mute(m2);
      }
      function F(m2) {
        var S;
        for (S = 0; S < s; S += 1)
          e[S].animation.unmute(m2);
      }
      ...
      return y.prototype = { get: function(p) {
        ...
        for (var p = this._p[0], c = this._p[2], b = 0; b < u; ++b)
          this._mSampleValues[b] = _(b * h, p, c);
      }, _getTForX: function(p) {
        for (var c = this._p[0], b = this._p[2], P = this._mSampleValues, x = 0, T = 1, I = u - 1; T !== I && P[T] <= p; ++T)
          x += h;
        --T;
    ...
    function Gs() {
      ...
      var s = /* @__PURE__ */ function() {
        return function(l, _, k, w) {
          ...
          for (p = k.length, y = 0; y < C; y += 1) {
            for (b = y / (C - 1), x = 0, v = 0; v < p; v += 1)
              c = ct(1 - b, 3) * l[v] + 3 * ct(1 - b, 2) * b * k[v] + 3 * (1 - b) * ct(b, 2) * w[v] + ct(b, 3) * _[v], T[v] = c, I[v] !== null && (x += ct(T[v] - I[v], 2)), I[v] = T[v];
      ...
      function r(l) {
        ...
        for (v = 0; v < p - 1; v += 1)
          c[v] = s(w[v], w[v + 1], C[v], y[v + 1]), b += c[v].addedLength;
        ...
        return function(_, k, w, C) {
          ...
          if (!l[y]) {
            ...
            for (b = w.length, p = 0; p < v; p += 1) {
              for (j = $(b), x = p / (v - 1), I = 0, c = 0; c < b; c += 1)
                P = ct(1 - x, 3) * _[c] + 3 * ct(1 - x, 2) * x * (_[c] + w[c]) + 3 * (1 - x) * ct(x, 2) * (k[c] + C[c]) + ct(x, 3) * k[c], j[c] = P, D !== null && (I += ct(j[c] - D[c], 2));
      ...
      function h(l, _) {
        ...
        if (y === C - 1 || y === 0 || v === w[y])
          return k[y];
        for (var c = w[y] > v ? -1 : 1, b = true; b; )
          if (w[y] <= v && w[y + 1] > v ? (p = (v - w[y]) / (w[y + 1] - w[y]), b = false) : y += c, y < 0 || y >= C - 1) {
            if (y === C - 1)
              return k[y];
            b = false;
          }
      ...
      function E(l, _, k, w, C, y, v) {
        ...
        for (b = 0; b < P; b += 1)
          g[b * 4] = t.round((I * l[b] + j * k[b] + D * w[b] + L * _[b]) * 1e3) / 1e3, g[b * 4 + 1] = t.round((G * l[b] + R * k[b] + F * w[b] + m2 * _[b]) * 1e3) / 1e3, g[b * 4 + 2] = t.round((S * l[b] + o * k[b] + f * w[b] + M * _[b]) * 1e3) / 1e3, g[b * 4 + 3] = t.round((A * l[b] + B * k[b] + q * w[b] + W * _[b]) * 1e3) / 1e3;
        return g;
      }
    ...
    function Yi(t, e) {
      ...
      if (h.to) {
        ...
        if (t >= y || t < v) {
          ...
          for (l = c.points[b].point.length, E = 0; E < l; E += 1)
            s[E] = c.points[b].point[E];
        } else {
          ...
          for (w = e.lastFrame < t && e._lastKeyframeIndex === n ? e._lastPoint : 0, u = true, k = c.points.length; u; ) {
            if (T += c.points[w].partialLength, P === 0 || _ === 0 || w === c.points.length - 1) {
              for (l = c.points[w].point.length, E = 0; E < l; E += 1)
                s[E] = c.points[w].point[E];
              break;
            } else if (P >= T && P < T + c.points[w + 1].partialLength) {
              for (x = (P - T) / c.points[w + 1].partialLength, l = c.points[w].point.length, E = 0; E < l; E += 1)
                s[E] = c.points[w].point[E] + (c.points[w + 1].point[E] - c.points[w].point[E]) * x;
              break;
            }
            w < k - 1 ? w += 1 : u = false;
          }
    ...
    function Ge(t) {
      ...
      if (this.propType === "unidimensional")
        e = t * this.mult, Xi(this.v - e) > 1e-5 && (this.v = e, this._mdf = true);
      else
        for (var i = 0, s = this.v.length; i < s; )
          e = t[i] * this.mult, Xi(this.v[i] - e) > 1e-5 && (this.v[i] = e, this._mdf = true), i += 1;
    }
    function He() {
    ...
    function Zs(t, e, i, s) {
      ...
      var r, n = e.k.length;
      for (this.v = ht("float32", n), this.pv = ht("float32", n), this.vel = ht("float32", n), r = 0; r < n; r += 1)
    ...
    function Us(t, e, i, s) {
      ...
      for (this.v = ht("float32", g), this.pv = ht("float32", g), r = 0; r < g; r += 1)
        this.v[r] = ie, this.pv[r] = ie;
    ...
    zt.prototype.setPathData = function(t, e) {
      ...
      for (var i = 0; i < e; )
        this.v[i] = se.newElement(), this.o[i] = se.newElement(), this.i[i] = se.newElement(), i += 1;
      ...
      for (u = r; u < a; u += 1)
        t.setTripleAt(e[n][0], e[n][1], s[n][0], s[n][1], i[n][0], i[n][1], u, false), n -= 1;
      return t;
    ...
    var ft = function() {
      ...
      function e(r) {
        var n = r._length, a;
        for (a = 0; a < n; a += 1)
          se.release(r.v[a]), se.release(r.i[a]), se.release(r.o[a]), r.v[a] = null, r.i[a] = null, r.o[a] = null;
        r._length = 0, r.c = false;
      }
      function i(r) {
        var n = s.newElement(), a, u = r._length === void 0 ? r.v.length : r._length;
        for (n.setLength(u), n.c = r.c, a = 0; a < u; a += 1)
          n.setTripleAt(r.v[a][0], r.v[a][1], r.o[a][0], r.o[a][1], r.i[a][0], r.i[a][1], a);
        return n;
      }
      var s = We(4, t, e);
      return s.clone = i, s;
    ...
    var fe = function() {
      ...
      function e(y, v, p) {
        ...
        if (y < R[0].t - this.offsetTime)
          b = R[0].s[0], x = true, c = 0;
        else if (y >= R[R.length - 1].t - this.offsetTime)
          b = R[R.length - 1].s ? R[R.length - 1].s[0] : R[R.length - 2].e[0], x = true;
        else {
          for (var F = c, m2 = R.length - 1, S = true, o, f, M; S && (o = R[F], f = R[F + 1], !(f.t - this.offsetTime > y)); )
            F < m2 - 1 ? F += 1 : S = false;
          if (M = this.keyframesMetadata[F] || {}, x = o.h === 1, c = F, !x) {
            if (y >= f.t - this.offsetTime)
              L = 1;
            else if (y < o.t - this.offsetTime)
              L = 0;
            else {
              var A;
        ...
        for (j = v._length, D = b.i[0].length, p.lastIndex = c, T = 0; T < j; T += 1)
          for (I = 0; I < D; I += 1)
            G = x ? b.i[T][I] : b.i[T][I] + (P.i[T][I] - b.i[T][I]) * L, v.i[T][I] = G, G = x ? b.o[T][I] : b.o[T][I] + (P.o[T][I] - b.o[T][I]) * L, v.o[T][I] = G, G = x ? b.v[T][I] : b.v[T][I] + (P.v[T][I] - b.v[T][I]) * L, v.v[T][I] = G;
      }
      function i() {
      ...
      function r(y, v) {
        if (y._length !== v._length || y.c !== v.c)
          return false;
        var p, c = y._length;
        for (p = 0; p < c; p += 1)
          if (y.v[p][0] !== v.v[p][0] || y.v[p][1] !== v.v[p][1] || y.o[p][0] !== v.o[p][0] || y.o[p][1] !== v.o[p][1] || y.i[p][0] !== v.i[p][0] || y.i[p][1] !== v.i[p][1])
            return false;
        return true;
      }
      function n(y) {
      ...
      function _(y, v, p) {
        ...
        if (p === 3 || p === 4) {
          ...
          p === 5 ? c = new l(y, v) : p === 6 ? c = new g(y, v) : p === 7 && (c = new E(y, v));
    ...
    var st = /* @__PURE__ */ function() {
      ...
      function w(o, f, M, A, B, q, W, X, Y, it, mt, Bt, gt, lt, kt, K) {
        var z = this.props;
        if (o === 1 && f === 0 && M === 0 && A === 0 && B === 0 && q === 1 && W === 0 && X === 0 && Y === 0 && it === 0 && mt === 1 && Bt === 0)
          return z[12] = z[12] * o + z[15] * gt, z[13] = z[13] * q + z[15] * lt, z[14] = z[14] * mt + z[15] * kt, z[15] *= K, this._identityCalculated = false, this;
      ...
      function L(o, f, M) {
        var A = ht("float32", 6);
        if (this.isIdentity())
          A[0] = o[0], A[1] = o[1], A[2] = f[0], A[3] = f[1], A[4] = M[0], A[5] = M[1];
        else {
      ...
      function F() {
        for (var o = 0, f = this.props, M = "matrix3d(", A = 1e4; o < 16; )
          M += s(f[o] * A) / A, M += o === 15 ? ")" : ",", o += 1;
        return M;
      }
      function m2(o) {
        var f = 1e4;
    ...
    H([Pt], Et), Et.prototype.initModifierProperties = function(t, e) {
      ...
      if (i === e)
        ...
        var k = [], w, C;
        for (a = 0; a < u; a += 1)
          if (w = this.shapes[a], !w.shape._mdf && !this._mdf && !t && this.m !== 2)
            w.shape.paths = w.localShapeCollection;
          else {
            if (n = w.shape.paths, d = n._length, l = 0, !w.shape._mdf && w.pathsData.length)
              l = w.totalShapeLength;
            else {
              for (g = this.releasePathsData(w.pathsData), h = 0; h < d; h += 1)
                E = Mt.getSegmentsLength(n.shapes[h]), g.push(E), l += E.totalLength;
        ...
        var y = e, v = i, p = 0, c;
        for (a = u - 1; a >= 0; a -= 1)
          if (w = this.shapes[a], w.shape._mdf) {
              ...
              if (k[0].s !== k[0].e) {
                if (k.length > 1) {
                  ...
                  if (P.c) {
                    ...
                    this.addPaths(b, C), b = this.addShapes(w, k[1]);
                }
                this.addPaths(b, C);
              }
            }
      ...
      for (i ? (E = i._length, w = i._length) : (i = ft.newElement(), E = 0, w = 0), k.push(i), n = 0; n < a; n += 1) {
        for (l = s[n].lengths, i.c = r[n].c, h = r[n].c ? l.length : l.length + 1, u = 1; u < h; u += 1)
          if (g = l[u - 1], d + g.addedLength < e.s)
            d += g.addedLength, i.c = false;
          else if (d > e.e) {
            i.c = false;
            break;
          } else
            e.s <= d && e.e >= d + g.addedLength ? (this.addSegment(r[n].v[u - 1], r[n].o[u - 1], r[n].i[u], r[n].v[u], i, E, C), C = false) : (_ = Mt.getNewSegment(r[n].v[u - 1], r[n].v[u], r[n].o[u - 1], r[n].i[u], (e.s - d) / g.addedLength, (e.e - d) / g.addedLength, l[u - 1]), this.addSegmentFromArray(_, i, E, C), C = false, i.c = false), d += g.addedLength, E += 1;
        if (r[n].c && l.length) {
          if (g = l[u - 1], d <= e.e) {
        ...
        if (i._length && (i.setXYAt(i.v[w][0], i.v[w][1], "i", w), i.setXYAt(i.v[i._length - 1][0], i.v[i._length - 1][1], "o", i._length - 1)), d > e.e)
          break;
    ...
    H([Pt], Ee), Ee.prototype.initModifierProperties = function(t, e) {
      ...
      var u, h, d, g, E, l;
      for (n = 0; n < r; n += 1)
        u = t.v[n][0] + (s[0] - t.v[n][0]) * i, h = t.v[n][1] + (s[1] - t.v[n][1]) * i, d = t.o[n][0] + (s[0] - t.o[n][0]) * -i, g = t.o[n][1] + (s[1] - t.o[n][1]) * -i, E = t.i[n][0] + (s[0] - t.i[n][0]) * -i, l = t.i[n][1] + (s[1] - t.i[n][1]) * -i, a.setTripleAt(u, h, d, g, E, l, n);
      return a;
      ...
      if (a !== 0) {
        var u, h;
        for (i = 0; i < s; i += 1) {
          if (u = this.shapes[i], h = u.localShapeCollection, !(!u.shape._mdf && !this._mdf && !t))
            for (h.releaseShapes(), u.shape._mdf = true, e = u.shape.paths.shapes, n = u.shape.paths._length, r = 0; r < n; r += 1)
              h.addShape(this.processPath(e[r], a));
      ...
      function a(h, d, g) {
        if (this.elem = h, this.frameId = -1, this.propType = "transform", this.data = d, this.v = new st(), this.pre = new st(), this.appliedTransformations = 0, this.initDynamicPropertyContainer(g || h), d.p && d.p.s ? (this.px = V.getProp(h, d.p.x, 0, 0, this), this.py = V.getProp(h, d.p.y, 0, 0, this), d.p.z && (this.pz = V.getProp(h, d.p.z, 0, 0, this))) : this.p = V.getProp(h, d.p || { k: [0, 0, 0] }, 1, 0, this), d.rx) {
          if (this.rx = V.getProp(h, d.rx, 0, U, this), this.ry = V.getProp(h, d.ry, 0, U, this), this.rz = V.getProp(h, d.rz, 0, U, this), d.or.k[0].ti) {
            ...
            for (E = 0; E < l; E += 1)
              d.or.k[E].to = null, d.or.k[E].ti = null;
          }
          this.or = V.getProp(h, d.or, 1, U, this), this.or.sh = true;
        } else
          this.r = V.getProp(h, d.r || { k: 0 }, 0, U, this);
    ...
    H([Pt], Tt), Tt.prototype.initModifierProperties = function(t, e) {
      ...
      if (this._mdf || t) {
        ...
        if (l > 0) {
          for (; v < k; )
            this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, false), v += 1;
          _ && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, _, false), v += _);
        } else if (l < 0) {
          for (; v > k; )
            this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, true), v -= 1;
    ...
    tt.prototype.point = function(t) {
      ...
      if (t <= 0)
        return [rs(this.points[0]), this];
      if (t >= 1)
        return [this, rs(this.points[this.points.length - 1])];
    ...
    function ns(t, e) {
      ...
      for (var n = lr(3 * t.a[e], 2 * t.b[e], t.c[e]), a = 0; a < n.length; a += 1)
        if (n[a] > 0 && n[a] < 1) {
          var u = t.point(n[a])[e];
          u < i ? i = u : u > s && (s = u);
        }
    ...
    xe.prototype.processPath = function(t, e, i, s) {
      ...
      if (n.c = t.c, t.c || (r -= 1), r === 0)
        return n;
      var a = -1, u = tt.shapeSegment(t, 0);
      os(n, t, 0, e, i, s, a);
      for (var h = 0; h < r; h += 1)
        a = cr(n, u, e, i, s, -a), h === r - 1 && !t.c ? u = null : u = tt.shapeSegment(t, (h + 1) % r), os(n, t, h + 1, e, i, s, a);
      return n;
      ...
      if (a !== 0) {
        var d, g;
        for (i = 0; i < s; i += 1) {
          if (d = this.shapes[i], g = d.localShapeCollection, !(!d.shape._mdf && !this._mdf && !t))
            for (g.releaseShapes(), d.shape._mdf = true, e = d.shape.paths.shapes, n = d.shape.paths._length, r = 0; r < n; r += 1)
              g.addShape(this.processPath(e[r], a, u, h));
    ...
    function dr(t) {
      for (var e, i = 1; i < t.length; i += 1)
        e = ps(t[i - 1], t[i]), t[i - 1] = e[0], t[i] = e[1];
    ...
    function us(t, e) {
      ...
      if (i.length === 0)
        return [ce(t, e)];
      if (i.length === 1 || Ue(i[1], 1))
        return n = t.split(i[0]), s = n[0], r = n[1], [ce(s, e), ce(r, e)];
      n = t.split(i[0]), s = n[0];
      var u = (i[1] - i[0]) / (1 - i[0]);
    ...
    H([Pt], Me), Me.prototype.initModifierProperties = function(t, e) {
      ...
      var a, u, h, d = [];
      for (a = 0; a < n; a += 1)
        h = tt.shapeSegment(t, a), d.push(us(h, e));
      if (!t.c)
        for (a = n - 1; a >= 0; a -= 1)
          h = tt.shapeSegmentInverted(t, a), d.push(us(h, e));
      d = dr(d);
      var g = null, E = null;
      for (a = 0; a < d.length; a += 1) {
        var l = d[a];
        for (E && (g = ls(r, E, l[0], i, s)), E = l[l.length - 1], u = 0; u < l.length; u += 1)
          h = l[u], g && ue(h.points[0], g) ? r.setXYAt(h.points[1][0], h.points[1][1], "o", r.length() - 1) : r.setTripleAt(h.points[0][0], h.points[0][1], h.points[1][0], h.points[1][1], h.points[0][0], h.points[0][1], r.length()), r.setTripleAt(h.points[3][0], h.points[3][1], h.points[3][0], h.points[3][1], h.points[2][0], h.points[2][1], r.length()), g = h.points[3];
      }
      ...
      if (a !== 0) {
        ...
        for (i = 0; i < s; i += 1) {
          if (d = this.shapes[i], g = d.localShapeCollection, !(!d.shape._mdf && !this._mdf && !t))
            for (g.releaseShapes(), d.shape._mdf = true, e = d.shape.paths.shapes, n = d.shape.paths._length, r = 0; r < n; r += 1)
              g.addShape(this.processPath(e[r], a, h, u));
          d.shape.paths = d.localShapeCollection;
        }
      }
      this.dynamicProperties.length || (this._mdf = false);
    ...
    function cs(t) {
      for (var e = t.fStyle ? t.fStyle.split(" ") : [], i = "normal", s = "normal", r = e.length, n, a = 0; a < r; a += 1)
    ...
    var re = function() {
      ...
      function l(m2) {
        ...
        for (o = 0; o < f; o += 1)
          S[o] !== "sans-serif" && S[o] !== "monospace" && M.push(S[o]);
        return M.join(",");
      }
      function _(m2, S) {
        var o = at("span");
      ...
      function k() {
        ...
        for (m2 = 0; m2 < S; m2 += 1)
          this.fonts[m2].loaded ? M -= 1 : this.fonts[m2].fOrigin === "n" || this.fonts[m2].origin === 0 ? this.fonts[m2].loaded = true : (o = this.fonts[m2].monoCase.node, f = this.fonts[m2].monoCase.w, o.offsetWidth !== f ? (M -= 1, this.fonts[m2].loaded = true) : (o = this.fonts[m2].sansCase.node, f = this.fonts[m2].sansCase.w, o.offsetWidth !== f && (M -= 1, this.fonts[m2].loaded = true)), this.fonts[m2].loaded && (this.fonts[m2].sansCase.parent.parentNode.removeChild(this.fonts[m2].sansCase.parent), this.fonts[m2].monoCase.parent.parentNode.removeChild(this.fonts[m2].monoCase.parent)));
      ...
      function C(m2, S) {
        ...
        for (f = 0; f < M; f += 1) {
          var B = true, q, W;
          if (o[f].loaded = false, o[f].monoCase = _(o[f].fFamily, "monospace"), o[f].sansCase = _(o[f].fFamily, "sans-serif"), !o[f].fPath)
            o[f].loaded = true, A -= 1;
            ...
            for (q = document.querySelectorAll('link[f-forigin="g"], link[f-origin="1"]'), W = 0; W < q.length; W += 1)
              q[W].href.indexOf(o[f].fPath) !== -1 && (B = false);
            if (B) {
              var Y = at("link");
      ...
      function y(m2) {
        if (m2) {
          ...
          for (S = 0; S < o; S += 1) {
            for (f = 0, A = false; f < M; )
              this.chars[f].style === m2[S].style && this.chars[f].fFamily === m2[S].fFamily && this.chars[f].ch === m2[S].ch && (A = true), f += 1;
      ...
      function v(m2, S, o) {
        for (var f = 0, M = this.chars.length; f < M; ) {
          if (this.chars[f].ch === m2 && this.chars[f].style === S && this.chars[f].fFamily === o)
            return this.chars[f];
          f += 1;
        }
      ...
      function p(m2, S, o) {
        ...
        if (!f.cache[M]) {
          ...
          if (m2 === " ") {
            ...
            f.cache[M] = A.measureText(m2) / 100;
        }
        return f.cache[M] * o;
      }
      function c(m2) {
        for (var S = 0, o = this.fonts.length; S < o; ) {
          if (this.fonts[S].fName === m2)
            return this.fonts[S];
          S += 1;
        }
        return this.fonts[0];
    ...
    function vs(t, e) {
      ...
      var s, r = i.length, n;
      for (s = 0; s < r; s += 1)
        n = new Te(i[s], e), this.effectElements.push(n);
    }
    function Te(t, e) {
      this.init(t, e);
    }
    ...
    rt.prototype.checkLayers = function(t) {
      ...
      for (var s = this.elements, r = this.layers, n = 0, a = r.length; n < a; )
        r[n].ind == e && (!s[n] || s[n] === true ? (this.buildItem(n), this.addPendingElement(t)) : (i.push(s[n]), s[n].setAsParent(), r[n].parent !== void 0 ? this.buildElementParenting(t, r[n].parent, i) : t.setHierarchy(i))), n += 1;
    ...
    Ft.prototype = { initTransform: function() {
      ...
      for (var s = true, r = this.comp; s; )
        r.finalTransform ? (r.data.hasMask && i.splice(0, 0, r.finalTransform), r = r.comp) : s = false;
      var n, a = i.length, u;
      for (n = 0; n < a; n += 1)
        u = i[n].mat.applyToPointArray(0, 0, 0), e = [e[0] - u[0], e[1] - u[1], 0];
      return e;
    }, mHelper: new st() };
    function Zt(t, e, i) {
      ...
      for (r = 0; r < n; r += 1)
        if ((u[r].mode !== "a" && u[r].mode !== "n" || u[r].inv || u[r].o.k !== 100 || u[r].o.x) && (y = "mask", v = "mask"), (u[r].mode === "s" || u[r].mode === "i") && h === 0 ? (_ = O("rect"), _.setAttribute("fill", "#ffffff"), _.setAttribute("width", this.element.comp.data.w || 0), _.setAttribute("height", this.element.comp.data.h || 0), d.push(_)) : _ = null, a = O("path"), u[r].mode === "n")
          this.viewData[r] = { op: V.getProp(this.element, u[r].o, 0, 0.01, this.element), prop: Ye.getShapeProp(this.element, u[r], 3), elem: a, lastPath: "" }, s.appendChild(a);
        else {
      ...
      for (this.maskElement = O(y), n = d.length, r = 0; r < n; r += 1)
    ...
    ve.prototype = { initRendererElement: function() {
      ...
      if (this.data.ln && this.layerElement.setAttribute("id", this.data.ln), this.data.cl && this.layerElement.setAttribute("class", this.data.cl), this.data.ty === 0 && !this.data.hd) {
        ...
        if (s.setAttribute("id", n), s.appendChild(r), this.globalData.defs.appendChild(s), this.checkMasks()) {
          ...
          this.layerElement.setAttribute("clip-path", "url(" + bt() + "#" + n + ")");
      }
    ...
    function ti(t, e, i, s) {
      ...
      for (r = 0; r < n; r += 1)
        a = V.getProp(t, e[r].v, 0, 0, this), this.k = a.k || this.k, this.dataProps[r] = { n: e[r].n, p: a };
    ...
    ge.prototype.initGradientData = function(t, e, i) {
      ...
      var r = [], n, a, u;
      for (u = e.g.p * 4, a = 0; a < u; a += 4)
        n = O("stop"), s.appendChild(n), r.push(n);
      ...
      if (this.g._hasOpacity && !this.g._collapsable) {
        ...
        for (s = t.g.p * 4; s < r; s += 2)
          i = O("stop"), i.setAttribute("stop-color", "rgb(255,255,255)"), d.appendChild(i), g.push(i);
    ...
    var Es = function(e, i, s, r) {
      ...
      for (h = 1; h < i; h += 1)
        d += " C" + r.applyToPointStringified(n[h - 1][0], n[h - 1][1]) + " " + r.applyToPointStringified(a[h][0], a[h][1]) + " " + r.applyToPointStringified(u[h][0], u[h][1]);
      ...
      function a(E, l, _) {
        ...
        for (p = 0; p < c; p += 1) {
          if (y = l.sh._mdf || _, l.styles[p].lvl < b) {
            for (x = e.reset(), T = b - l.styles[p].lvl, I = l.transformers.length - 1; !y && T > 0; )
              y = l.transformers[I].mProps._mdf || y, T -= 1, I -= 1;
            if (y)
              for (T = b - l.styles[p].lvl, I = l.transformers.length - 1; T > 0; )
                x.multiply(l.transformers[I].mProps.v), T -= 1, I -= 1;
          } else
            x = t;
          if (P = l.sh.paths, w = P._length, y) {
            for (C = "", k = 0; k < w; k += 1)
              v = P.shapes[k], v && v._length && (C += Es(v, v._length, v.c, x));
            l.caches[p] = C;
          } else
            C = l.caches[p];
      ...
      function d(E, l, _) {
        ...
        if (l.g._cmdf || _) {
          b = l.cst;
          var I = l.g.c;
          for (x = b.length, P = 0; P < x; P += 1)
            T = b[P], T.setAttribute("offset", I[P * 4] + "%"), T.setAttribute("stop-color", "rgb(" + I[P * 4 + 1] + "," + I[P * 4 + 2] + "," + I[P * 4 + 3] + ")");
        }
        if (w && (l.g._omdf || _)) {
          var j = l.g.o;
          for (l.g._collapsable ? b = l.cst : b = l.ost, x = b.length, P = 0; P < x; P += 1)
            T = b[P], l.g._collapsable || T.setAttribute("offset", j[P * 2] + "%"), T.setAttribute("stop-opacity", j[P * 2 + 1]);
        }
        if (E.t === 1)
          (l.e._mdf || _) && (k.setAttribute("x2", y[0]), k.setAttribute("y2", y[1]), w && !l.g._collapsable && (l.of.setAttribute("x2", y[0]), l.of.setAttribute("y2", y[1])));
        else {
          var D;
    ...
    H([_t, Ft, ve, ys, At, wt, ne], Q), Q.prototype.initSecondaryElement = function() {
      ...
      for (s = 0; s < r; s += 1) {
        for (n = this.stylesList[s], u = false, a.length = 0, t = 0; t < e; t += 1)
          i = this.shapes[t], i.styles.indexOf(n) !== -1 && (a.push(i), u = i._isAnimated || u);
      ...
      for (h = d; h >= 0; h -= 1) {
        if (C = this.searchProcessedElement(t[h]), C ? e[h] = i[C - 1] : t[h]._render = a, t[h].ty === "fl" || t[h].ty === "st" || t[h].ty === "gf" || t[h].ty === "gs" || t[h].ty === "no")
          C ? e[h].style.closed = false : e[h] = this.createStyleElement(t[h], r), t[h]._render && e[h].style.pElem.parentNode !== s && s.appendChild(e[h].style.pElem), l.push(e[h].style);
        else if (t[h].ty === "gr") {
          if (!C)
            e[h] = this.createGroupElement(t[h]);
          else
            for (E = e[h].it.length, g = 0; g < E; g += 1)
              e[h].prevViewData[g] = e[h].it[g];
      ...
      for (d = l.length, h = 0; h < d; h += 1)
        l[h].closed = true;
      for (d = _.length, h = 0; h < d; h += 1)
        _[h].closed = true;
    ...
    ut.prototype.defaultBoxWidth = [0, 0], ut.prototype.copyData = function(t, e) {
      ...
      if (t.sz)
        for (var T = true, I = t.sz[0], j = t.sz[1], D, L; T; ) {
          L = this.buildFinalText(t.t), D = 0, k = 0, n = L.length, P = t.tr / 1e3 * t.finalSize;
          var G = -1;
          for (r = 0; r < n; r += 1)
            x = L[r].charCodeAt(0), a = false, L[r] === " " ? G = r : (x === 13 || x === 3) && (k = 0, a = true, D += t.finalLineHeight || t.finalSize * 1.2), e.chars ? (p = e.getCharData(L[r], v.fStyle, v.fFamily), c = a ? 0 : p.w * t.finalSize / 100) : c = e.measureText(L[r], t.f, t.finalSize), k + c > I && L[r] !== " " ? (G === -1 ? n += 1 : r = G, D += t.finalLineHeight || t.finalSize * 1.2, L.splice(r, G === r ? 1 : 0, "\r"), G = -1, k = 0) : (k += c, k += P);
      ...
      for (r = 0; r < n; r += 1)
        if (a = false, F = t.finalText[r], x = F.charCodeAt(0), x === 13 || x === 3 ? (R = 0, _.push(k), w = k > w ? k : w, k = -2 * P, h = "", a = true, l += 1) : h = F, e.chars ? (p = e.getCharData(F, v.fStyle, e.getFontByName(t.f).fFamily), c = a ? 0 : p.w * t.finalSize / 100) : c = e.measureText(h, t.f, t.finalSize), F === " " ? R += c + P : (k += c + P + R, R = 0), s.push({ l: c, an: c, add: g, n: a, anIndexes: [], val: h, line: l, animatorJustifyOffset: 0 }), d == 2) {
          ...
          s[u].ind = u, s[u].extra = 0, u += 1;
      if (t.l = s, w = k > w ? k : w, _.push(k), t.sz)
      ...
      var f, M, A = [];
      for (C = 0; C < y; C += 1) {
        for (S = m2[C], S.a.sc && (t.strokeColorAnim = true), S.a.sw && (t.strokeWidthAnim = true), (S.a.fc || S.a.fh || S.a.fs || S.a.fb) && (t.fillColorAnim = true), M = 0, f = S.s.b, r = 0; r < n; r += 1)
          o = s[r], o.anIndexes[C] = M, (f == 1 && o.val !== "" || f == 2 && o.val !== "" && o.val !== " " || f == 3 && (o.n || o.val == " " || r == n - 1) || f == 4 && (o.n || r == n - 1)) && (S.s.rn === 1 && A.push(M), M += 1);
        i.a[C].s.totalChars = M;
        var B = -1, q;
        if (S.s.rn === 1)
          for (r = 0; r < n; r += 1)
            o = s[r], B != o.anIndexes[C] && (B = o.anIndexes[C], q = A.splice(Math.floor(Math.random() * A.length), 1)[0]), o.anIndexes[C] = q;
      }
    ...
    var Mr = function() {
      ...
      s.prototype = { getMult: function(a) {
        ...
        if (w === 2)
          k === _ ? l = a >= k ? 1 : 0 : l = t(0, e(0.5 / (k - _) + (a - _) / (k - _), 1)), l = E(l);
        else if (w === 3)
          k === _ ? l = a >= k ? 0 : 1 : l = 1 - t(0, e(0.5 / (k - _) + (a - _) / (k - _), 1)), l = E(l);
        else if (w === 4)
          k === _ ? l = 0 : (l = t(0, e(0.5 / (k - _) + (a - _) / (k - _), 1)), l < 0.5 ? l *= 2 : l = 1 - 2 * (l - 0.5)), l = E(l);
        else if (w === 5) {
          if (k === _)
            l = 0;
          else {
          ...
          w === 6 ? (k === _ ? l = 0 : (a = e(t(0, a + 0.5 - _), k - _), l = (1 + Math.cos(Math.PI + Math.PI * 2 * a / (k - _))) / 2), l = E(l)) : (a >= i(_) && (a - _ < 0 ? l = t(0, e(e(k, 1) - (_ - a), 1)) : l = t(0, e(k - a, 1))), l = E(l));
        if (this.sm.v !== 100) {
    ...
    ae.prototype.searchProperties = function() {
      ...
      for (t = 0; t < e; t += 1)
        i = this._textData.a[t], this._animatorsData[t] = new Tr(this._elem, i, this);
      ...
      if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
        ...
        if (this._hasMaskedPath) {
          if (D = this._pathData.m, !this._pathData.n || this._pathData._mdf) {
            ...
            var G;
            for (T = 0, g = 0; g < E; g += 1)
              G = Mt.buildBezierData(L.v[g], L.v[g + 1], [L.o[g][0] - L.v[g][0], L.o[g][1] - L.v[g][1]], [L.i[g + 1][0] - L.v[g + 1][0], L.i[g + 1][1] - L.v[g + 1][1]]), _.tLength += G.segmentLength, _.segments.push(G), T += G.segmentLength;
          ...
          if (_ = this._pathData.pi, k = this._pathData.f.v, p = 0, v = 1, C = 0, y = true, P = _.segments, k < 0 && D.v.c)
            for (_.tLength < Math.abs(k) && (k = -Math.abs(k) % _.tLength), p = P.length - 1, b = P[p].points, v = b.length - 1; k < 0; )
              k += b[v].partialLength, v -= 1, v < 0 && (p -= 1, b = P[p].points, v = b.length - 1);
        ...
        if (t.j === 2 || t.j === 1) {
          ...
          for (g = 0; g < E; g += 1)
            if (l[g].n) {
              for (yt && (yt += Qt); Ct < g; )
                l[Ct].animatorJustifyOffset = yt, Ct += 1;
              yt = 0, te = true;
            } else {
              for (o = 0; o < f; o += 1)
                m2 = s[o].a, m2.t.propType && (te && t.j === 2 && (Qt += m2.t.v * $t), S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? yt += m2.t.v * A[0] * $t : yt += m2.t.v * A * $t);
              te = false;
            }
          for (yt && (yt += Qt); Ct < g; )
            l[Ct].animatorJustifyOffset = yt, Ct += 1;
        ...
        for (g = 0; g < E; g += 1) {
          if (n.reset(), gt = 1, l[g].n)
            h = 0, d += t.yOffset, d += F ? 1 : 0, k = Y, F = false, this._hasMaskedPath && (p = it, v = mt, b = P[p].points, c = b[v - 1], w = b[v], x = w.partialLength, C = 0), Rt = "", Nt = "", Dt = "", jt = "", qt = this.defaultPropsArray;
          else {
            if (this._hasMaskedPath) {
              if (Bt !== l[g].line) {
                switch (t.j) {
              ...
              var xt = 0;
              for (o = 0; o < f; o += 1)
                m2 = s[o].a, m2.p.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? xt += m2.p.v[0] * A[0] : xt += m2.p.v[0] * A), m2.a.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? xt += m2.a.v[0] * A[0] : xt += m2.a.v[0] * A);
              for (y = true, this._pathData.a.v && (k = l[0].an * 0.5 + (T - this._pathData.f.v - l[0].an * 0.5 - l[l.length - 1].an * 0.5) * B / (E - 1), k += this._pathData.f.v); y; )
                C + x >= k + xt || !b ? (I = (k + xt - C) / w.partialLength, W = c.point[0] + (w.point[0] - c.point[0]) * I, X = c.point[1] + (w.point[1] - c.point[1]) * I, n.translate(-i[0] * l[g].an * 5e-3, -(i[1] * R) * 0.01), y = false) : b && (C += w.partialLength, v += 1, v >= b.length && (v = 0, p += 1, P[p] ? b = P[p].points : D.v.c ? (v = 0, p = 0, b = P[p].points) : (C -= w.partialLength, b = null)), b && (c = w, w = b[v], x = w.partialLength));
              q = l[g].an / 2 - l[g].add, n.translate(-q, 0, 0);
            } else
              q = l[g].an / 2 - l[g].add, n.translate(-q, 0, 0), n.translate(-i[0] * l[g].an * 5e-3, -i[1] * R * 0.01, 0);
            for (o = 0; o < f; o += 1)
              m2 = s[o].a, m2.t.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), (h !== 0 || t.j !== 0) && (this._hasMaskedPath ? A.length ? k += m2.t.v * A[0] : k += m2.t.v * A : A.length ? h += m2.t.v * A[0] : h += m2.t.v * A));
            for (t.strokeWidthAnim && (kt = t.sw || 0), t.strokeColorAnim && (t.sc ? lt = [t.sc[0], t.sc[1], t.sc[2]] : lt = [0, 0, 0]), t.fillColorAnim && t.fc && (K = [t.fc[0], t.fc[1], t.fc[2]]), o = 0; o < f; o += 1)
              m2 = s[o].a, m2.a.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? n.translate(-m2.a.v[0] * A[0], -m2.a.v[1] * A[1], m2.a.v[2] * A[2]) : n.translate(-m2.a.v[0] * A, -m2.a.v[1] * A, m2.a.v[2] * A));
            for (o = 0; o < f; o += 1)
              m2 = s[o].a, m2.s.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? n.scale(1 + (m2.s.v[0] - 1) * A[0], 1 + (m2.s.v[1] - 1) * A[1], 1) : n.scale(1 + (m2.s.v[0] - 1) * A, 1 + (m2.s.v[1] - 1) * A, 1));
            for (o = 0; o < f; o += 1) {
              if (m2 = s[o].a, S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), m2.sk.propType && (A.length ? n.skewFromAxis(-m2.sk.v * A[0], m2.sa.v * A[1]) : n.skewFromAxis(-m2.sk.v * A, m2.sa.v * A)), m2.r.propType && (A.length ? n.rotateZ(-m2.r.v * A[2]) : n.rotateZ(-m2.r.v * A)), m2.ry.propType && (A.length ? n.rotateY(m2.ry.v * A[1]) : n.rotateY(m2.ry.v * A)), m2.rx.propType && (A.length ? n.rotateX(m2.rx.v * A[0]) : n.rotateX(m2.rx.v * A)), m2.o.propType && (A.length ? gt += (m2.o.v * A[0] - gt) * A[0] : gt += (m2.o.v * A - gt) * A), t.strokeWidthAnim && m2.sw.propType && (A.length ? kt += m2.sw.v * A[0] : kt += m2.sw.v * A), t.strokeColorAnim && m2.sc.propType)
                for (z = 0; z < 3; z += 1)
                  A.length ? lt[z] += (m2.sc.v[z] - lt[z]) * A[0] : lt[z] += (m2.sc.v[z] - lt[z]) * A;
              if (t.fillColorAnim && t.fc) {
                if (m2.fc.propType)
                  for (z = 0; z < 3; z += 1)
                    A.length ? K[z] += (m2.fc.v[z] - K[z]) * A[0] : K[z] += (m2.fc.v[z] - K[z]) * A;
            ...
            for (o = 0; o < f; o += 1)
              m2 = s[o].a, m2.p.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), this._hasMaskedPath ? A.length ? n.translate(0, m2.p.v[1] * A[0], -m2.p.v[2] * A[1]) : n.translate(0, m2.p.v[1] * A, -m2.p.v[2] * A) : A.length ? n.translate(m2.p.v[0] * A[0], m2.p.v[1] * A[1], -m2.p.v[2] * A[2]) : n.translate(m2.p.v[0] * A, m2.p.v[1] * A, -m2.p.v[2] * A));
    ...
    St.prototype.initElement = function(t, e, i) {
      ...
      for (i = 0; i < s; i += 1)
        e[i].ty === "sh" && (r = e[i].ks.k, n += Es(r, r.i.length, true, t));
      return n;
    ...
    H([_t, Ft, ve, At, wt, ne, St], It), It.prototype.createContent = function() {
      ...
      for (var e = 0, i = t.length, s = [], r = ""; e < i; )
        t[e] === String.fromCharCode(13) || t[e] === String.fromCharCode(3) ? (s.push(r), r = "") : r += t[e], e += 1;
      return s.push(r), s;
      ...
      if (E && !u && !i.sz) {
        ...
        for (e = v.length, _ = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1)
          h = this.textSpans[t].span || O("tspan"), h.textContent = v[t], h.setAttribute("x", 0), h.setAttribute("y", _), h.style.display = "inherit", C.appendChild(h), this.textSpans[t] || (this.textSpans[t] = { span: null, glyph: null }), this.textSpans[t].span = h, _ += i.finalLineHeight;
        ...
        for (t = 0; t < e; t += 1) {
          ...
          if (d.reset(), E && (a[t].n && (l = -w, _ += i.yOffset, _ += k ? 1 : 0, k = false), this.applyTextPropertiesToMatrix(i, d, a[t].line, l, _), l += a[t].l || 0, l += w), u) {
            ...
            var P;
            if (c.t === 1)
              P = new he(c.data, this.globalData, this);
            else {
              var x = Fr;
            ...
            E && h.setAttribute("transform", "translate(" + d.props[12] + "," + d.props[13] + ")"), h.textContent = a[t].val, h.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve");
        }
      ...
      if (this.validateText(), (!this.data.singleShape || this._mdf) && (this.textAnimator.getMeasures(this.textProperty.currentData, this.lettersChangedFlag), this.lettersChangedFlag || this.textAnimator.lettersChangedFlag)) {
        ...
        var r, n, a;
        for (t = 0; t < e; t += 1)
          s[t].n || (r = i[t], n = this.textSpans[t].span, a = this.textSpans[t].glyph, a && a.renderFrame(), r._mdf.m && n.setAttribute("transform", r.m), r._mdf.o && n.setAttribute("opacity", r.o), r._mdf.sw && n.setAttribute("stroke-width", r.sw), r._mdf.sc && n.setAttribute("stroke", r.sc), r._mdf.fc && n.setAttribute("fill", r.fc));
      }
    };
    function ei(t, e, i) {
    ...
    H([rt], nt), nt.prototype.createNull = function(t) {
      ...
      if (i) {
        for (var s = 0, r; s < e; )
          this.elements[s] && this.elements[s] !== true && this.elements[s].getBaseElement() && (r = this.elements[s].getBaseElement()), s += 1;
    ...
    H([_t, Ft, Ve, Q, Vt, At, wt, de], pt), pt.prototype._renderShapeFrame = pt.prototype.renderInnerContent, pt.prototype.createContent = function() {
      ...
      if (!(n <= 1)) {
        for (r = 0; r < n - 1; r += 1)
          a = this.getTransformedPoint(s, i.v[r]), u = this.getTransformedPoint(s, i.o[r]), h = this.getTransformedPoint(s, i.i[r + 1]), d = this.getTransformedPoint(s, i.v[r + 1]), this.checkBounds(a, u, h, d, e);
      ...
      for (var r = [[t[0], s[0]], [t[1], s[1]]], n, a, u, h, d, g, E, l = 0; l < 2; ++l)
        a = 6 * t[l] - 12 * e[l] + 6 * i[l], n = -3 * t[l] + 9 * e[l] - 9 * i[l] + 3 * s[l], u = 3 * e[l] - 3 * t[l], a |= 0, n |= 0, u |= 0, n === 0 && a === 0 || (n === 0 ? (h = -u / a, h > 0 && h < 1 && r[l].push(this.calculateF(h, t, e, i, s, l))) : (d = a * a - 4 * u * n, d >= 0 && (g = (-a + Oe(d)) / (2 * n), g > 0 && g < 1 && r[l].push(this.calculateF(g, t, e, i, s, l)), E = (-a - Oe(d)) / (2 * n), E > 0 && E < 1 && r[l].push(this.calculateF(E, t, e, i, s, l)))));
    ...
    H([_t, Ft, Vt, At, wt, ne, St], Be), Be.prototype.createContent = function() {
      ...
      for (a = 0; a < u; a += 1) {
        if (this.globalData.fontManager.chars ? (this.textPaths[w] ? d = this.textPaths[w] : (d = O("path"), d.setAttribute("stroke-linecap", _i[1]), d.setAttribute("stroke-linejoin", wi[2]), d.setAttribute("stroke-miterlimit", "4")), this.isMasked || (this.textSpans[w] ? (g = this.textSpans[w], E = g.children[0]) : (g = at("div"), g.style.lineHeight = 0, E = O("svg"), E.appendChild(d), Gt(g)))) : this.isMasked ? d = this.textPaths[w] ? this.textPaths[w] : O("text") : this.textSpans[w] ? (g = this.textSpans[w], d = this.textPaths[w]) : (g = at("span"), Gt(g), d = at("span"), Gt(d), g.appendChild(d)), this.globalData.fontManager.chars) {
          ...
          if (C ? y = C.data : y = null, l.reset(), y && y.shapes && y.shapes.length && (_ = y.shapes[0].it, l.scale(t.finalSize / 100, t.finalSize / 100), k = this.createPathShape(l, _), d.setAttribute("d", k)), this.isMasked)
        ...
        } else if (d.textContent = h[a].val, d.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve"), this.isMasked)
          this.innerElem.appendChild(d);
        else {
      ...
      if (this.textAnimator.getMeasures(this.textProperty.currentData, this.lettersChangedFlag), !(!this.lettersChangedFlag && !this.textAnimator.lettersChangedFlag)) {
        ...
        var u, h, d;
        for (i = 0; i < s; i += 1)
          a[i].n ? r += 1 : (h = this.textSpans[i], d = this.textPaths[i], u = n[r], r += 1, u._mdf.m && (this.isMasked ? h.setAttribute("transform", u.m) : (h.style.webkitTransform = u.m, h.style.transform = u.m)), h.style.opacity = u.o, u.sw && u._mdf.sw && d.setAttribute("stroke-width", u.sw), u.sc && u._mdf.sc && d.setAttribute("stroke", u.sc), u.fc && u._mdf.fc && (d.setAttribute("fill", u.fc), d.style.color = u.fc));
    ...
    H([rt], J), J.prototype.buildItem = Le.prototype.buildItem, J.prototype.checkPendingElements = function() {
      ...
      if (i) {
        ...
        if (!s.ddd || !this.supports3d)
          if (this.threeDElements)
            ...
            for (var r = 0, n, a, u; r < e; )
              this.elements[r] && this.elements[r] !== true && this.elements[r].getBaseElement && (a = this.elements[r], u = this.layers[r].ddd ? this.getThreeDContainerByPos(r) : a.getBaseElement(), n = u || n), r += 1;
      ...
      for (var i = 0, s = this.threeDElements.length; i < s; ) {
        if (e <= this.threeDElements[i].endPos) {
          for (var r = this.threeDElements[i].startPos, n; r < e; )
...
@dotlottie/common/dist/lottie_light_html-SLCECTRT.js:
  ...
  *)
*/
//# sourceMappingURL=lottie_light_html-SLCECTRT-FCAV36LP.js.map
