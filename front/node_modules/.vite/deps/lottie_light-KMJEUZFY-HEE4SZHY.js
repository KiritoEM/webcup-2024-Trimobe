      ...
      function u() {
        s || (s = o(function(b) {
          function P() {
            ...
            function y(F, v) {
              if (F) {
                var k = 0, a = F.length;
                for (k = 0; k < a; k += 1)
                  F[k].t === 1 && (F[k].data.layers = f(F[k].data.refId, v), C(F[k].data.layers, v));
              }
            }
            function d(F, v) {
            ...
            var T = /* @__PURE__ */ function() {
              ...
              return function(a) {
                if (A(F, a.v) && (k(a.layers), a.assets)) {
                  ...
                  for (l = 0; l < E; l += 1)
                    a.assets[l].layers && k(a.assets[l].layers);
                }
              };
            }(), x = /* @__PURE__ */ function() {
              var F = [4, 7, 99];
          ...
          if (r.dataManager || (r.dataManager = P()), r.assetLoader || (r.assetLoader = /* @__PURE__ */ function() {
            ...
            b.data.type === "loadData" && r.assetLoader.load(b.data.path, b.data.fullPath, function(C) {
...
`), s = {}, n, r = 0, o = 0; o < i.length; o += 1)
    ...
    var tt = function() {
      ...
      function u(v) {
        for (var k = 0, a = v.target; k < s; )
          e[k].animation === a && (e.splice(k, 1), k -= 1, s -= 1, a.isPaused || M()), k += 1;
      }
      function h(v, k) {
        if (!v)
          return null;
      ...
      function P(v, k) {
        var a;
        for (a = 0; a < s; a += 1)
          e[a].animation.setSpeed(v, k);
      }
      function S(v, k) {
        var a;
        for (a = 0; a < s; a += 1)
          e[a].animation.setDirection(v, k);
      }
      function C(v) {
        var k;
        for (k = 0; k < s; k += 1)
          e[k].animation.play(v);
      }
      function y(v) {
        var k = v - i, a;
        for (a = 0; a < s; a += 1)
          e[a].animation.advanceTime(k);
      ...
      function f(v) {
        var k;
        for (k = 0; k < s; k += 1)
          e[k].animation.pause(v);
      }
      function c(v, k, a) {
        var l;
        for (l = 0; l < s; l += 1)
          e[l].animation.goToAndStop(v, k, a);
      }
      function g(v) {
        var k;
        for (k = 0; k < s; k += 1)
          e[k].animation.stop(v);
      }
      function A(v) {
        var k;
        for (k = 0; k < s; k += 1)
          e[k].animation.togglePause(v);
      }
      function T(v) {
        var k;
        for (k = s - 1; k >= 0; k -= 1)
          e[k].animation.destroy(v);
      }
      function x(v, k, a) {
      ...
      function G(v, k) {
        var a;
        for (a = 0; a < s; a += 1)
          e[a].animation.setVolume(v, k);
      }
      function O(v) {
        var k;
        for (k = 0; k < s; k += 1)
          e[k].animation.mute(v);
      }
      function F(v) {
        var k;
        for (k = 0; k < s; k += 1)
          e[k].animation.unmute(v);
      }
      ...
      return y.prototype = { get: function(f) {
        ...
        for (var f = this._p[0], c = this._p[2], g = 0; g < u; ++g)
          this._mSampleValues[g] = b(g * h, f, c);
      }, _getTForX: function(f) {
        for (var c = this._p[0], g = this._p[2], A = this._mSampleValues, T = 0, x = 1, I = u - 1; x !== I && A[x] <= f; ++x)
          T += h;
        --x;
    ...
    function Fs() {
        ...
        return function(p, b, P, S) {
          ...
          for (f = P.length, y = 0; y < C; y += 1) {
            for (g = y / (C - 1), T = 0, d = 0; d < f; d += 1)
              c = kt(1 - g, 3) * p[d] + 3 * kt(1 - g, 2) * g * P[d] + 3 * (1 - g) * kt(g, 2) * S[d] + kt(g, 3) * b[d], x[d] = c, I[d] !== null && (T += kt(x[d] - I[d], 2)), I[d] = x[d];
      ...
      function n(p) {
        ...
        for (d = 0; d < f - 1; d += 1)
          c[d] = s(S[d], S[d + 1], C[d], y[d + 1]), g += c[d].addedLength;
        ...
        return function(b, P, S, C) {
          ...
          if (!p[y]) {
            ...
            for (g = S.length, f = 0; f < d; f += 1) {
              for (j = $(g), T = f / (d - 1), I = 0, c = 0; c < g; c += 1)
                A = kt(1 - T, 3) * b[c] + 3 * kt(1 - T, 2) * T * (b[c] + S[c]) + 3 * (1 - T) * kt(T, 2) * (P[c] + C[c]) + kt(T, 3) * P[c], j[c] = A, N !== null && (I += kt(j[c] - N[c], 2));
      ...
      function h(p, b) {
        ...
        if (y === C - 1 || y === 0 || d === S[y])
          return P[y];
        for (var c = S[y] > d ? -1 : 1, g = true; g; )
          if (S[y] <= d && S[y + 1] > d ? (f = (d - S[y]) / (S[y + 1] - S[y]), g = false) : y += c, y < 0 || y >= C - 1) {
            if (y === C - 1)
              return P[y];
            g = false;
          }
      ...
      function M(p, b, P, S, C, y, d) {
        ...
        for (g = 0; g < A; g += 1)
          _[g * 4] = t.round((I * p[g] + j * P[g] + N * S[g] + L * b[g]) * 1e3) / 1e3, _[g * 4 + 1] = t.round((G * p[g] + O * P[g] + F * S[g] + v * b[g]) * 1e3) / 1e3, _[g * 4 + 2] = t.round((k * p[g] + a * P[g] + l * S[g] + E * b[g]) * 1e3) / 1e3, _[g * 4 + 3] = t.round((w * p[g] + R * P[g] + q * S[g] + D * b[g]) * 1e3) / 1e3;
        return _;
      }
    ...
    function Fi(t, e) {
      ...
      if (h.to) {
        ...
        if (t >= y || t < d) {
          ...
          for (p = c.points[g].point.length, M = 0; M < p; M += 1)
            s[M] = c.points[g].point[M];
        } else {
          ...
          for (S = e.lastFrame < t && e._lastKeyframeIndex === r ? e._lastPoint : 0, u = true, P = c.points.length; u; ) {
            if (x += c.points[S].partialLength, A === 0 || b === 0 || S === c.points.length - 1) {
              ...
              for (T = (A - x) / c.points[S + 1].partialLength, p = c.points[S].point.length, M = 0; M < p; M += 1)
                s[M] = c.points[S].point[M] + (c.points[S + 1].point[M] - c.points[S].point[M]) * T;
              break;
            }
            S < P - 1 ? S += 1 : u = false;
          }
        ...
        var I, j, N, L, G;
        if (o = h.s.length, f = m2.s || h.e, this.sh && h.h !== 1)
          if (t >= y)
    ...
    Tt.prototype.setPathData = function(t, e) {
      ...
      for (u = n; u < o; u += 1)
        t.setTripleAt(e[r][0], e[r][1], s[r][0], s[r][1], i[r][0], i[r][1], u, false), r -= 1;
      return t;
    ...
    var at = function() {
      ...
      function i(n) {
        ...
        for (r.setLength(u), r.c = n.c, o = 0; o < u; o += 1)
    ...
    var te = function() {
      ...
      function e(y, d, f) {
        ...
        if (y < O[0].t - this.offsetTime)
          g = O[0].s[0], T = true, c = 0;
        else if (y >= O[O.length - 1].t - this.offsetTime)
          g = O[O.length - 1].s ? O[O.length - 1].s[0] : O[O.length - 2].e[0], T = true;
        else {
          for (var F = c, v = O.length - 1, k = true, a, l, E; k && (a = O[F], l = O[F + 1], !(l.t - this.offsetTime > y)); )
            F < v - 1 ? F += 1 : k = false;
        ...
        for (j = d._length, N = g.i[0].length, f.lastIndex = c, x = 0; x < j; x += 1)
          for (I = 0; I < N; I += 1)
      ...
      function b(y, d, f) {
        ...
        if (f === 3 || f === 4) {
          ...
          f === 5 ? c = new p(y, d) : f === 6 ? c = new _(y, d) : f === 7 && (c = new M(y, d));
    ...
    var ot = /* @__PURE__ */ function() {
      ...
      function S(a, l, E, w, R, q, D, Y, H, et, ut, wt, ct, nt, mt, K) {
        var B = this.props;
        if (a === 1 && l === 0 && E === 0 && w === 0 && R === 0 && q === 1 && D === 0 && Y === 0 && H === 0 && et === 0 && ut === 1 && wt === 0)
          return B[12] = B[12] * a + B[15] * ct, B[13] = B[13] * q + B[15] * nt, B[14] = B[14] * ut + B[15] * mt, B[15] *= K, this._identityCalculated = false, this;
    ...
    X([gt], _t), _t.prototype.initModifierProperties = function(t, e) {
      ...
      if (i === e)
        for (o = 0; o < u; o += 1)
          this.shapes[o].localShapeCollection.releaseShapes(), this.shapes[o].shape._mdf = true, this.shapes[o].shape.paths = this.shapes[o].localShapeCollection, this._mdf && (this.shapes[o].pathsData.length = 0);
      else if (i === 1 && e === 0 || i === 0 && e === 1) {
        if (this._mdf)
          for (o = 0; o < u; o += 1)
            this.shapes[o].pathsData.length = 0, this.shapes[o].shape._mdf = true;
      } else {
        var P = [], S, C;
        for (o = 0; o < u; o += 1)
          if (S = this.shapes[o], !S.shape._mdf && !this._mdf && !t && this.m !== 2)
            ...
            if (r = S.shape.paths, m2 = r._length, p = 0, !S.shape._mdf && S.pathsData.length)
              p = S.totalShapeLength;
            else {
              for (_ = this.releasePathsData(S.pathsData), h = 0; h < m2; h += 1)
                M = Pt.getSegmentsLength(r.shapes[h]), _.push(M), p += M.totalLength;
              ...
              if (P[0].s !== P[0].e) {
                if (P.length > 1) {
                  ...
                  if (A.c) {
                    ...
                    this.addPaths(g, C), g = this.addShapes(S, P[1]);
                }
                this.addPaths(g, C);
              }
            }
      ...
      for (i ? (M = i._length, S = i._length) : (i = at.newElement(), M = 0, S = 0), P.push(i), r = 0; r < o; r += 1) {
        for (p = s[r].lengths, i.c = n[r].c, h = n[r].c ? p.length : p.length + 1, u = 1; u < h; u += 1)
          if (_ = p[u - 1], m2 + _.addedLength < e.s)
            m2 += _.addedLength, i.c = false;
          else if (m2 > e.e) {
            i.c = false;
            break;
          } else
            e.s <= m2 && e.e >= m2 + _.addedLength ? (this.addSegment(n[r].v[u - 1], n[r].o[u - 1], n[r].i[u], n[r].v[u], i, M, C), C = false) : (b = Pt.getNewSegment(n[r].v[u - 1], n[r].v[u], n[r].o[u - 1], n[r].i[u], (e.s - m2) / _.addedLength, (e.e - m2) / _.addedLength, p[u - 1]), this.addSegmentFromArray(b, i, M, C), C = false, i.c = false), m2 += _.addedLength, M += 1;
        if (n[r].c && p.length) {
          if (_ = p[u - 1], m2 <= e.e) {
        ...
        if (i._length && (i.setXYAt(i.v[S][0], i.v[S][1], "i", S), i.setXYAt(i.v[i._length - 1][0], i.v[i._length - 1][1], "o", i._length - 1)), m2 > e.e)
          break;
    ...
    X([gt], ce), ce.prototype.initModifierProperties = function(t, e) {
      ...
      var u, h, m2, _, M, p;
      for (r = 0; r < n; r += 1)
        u = t.v[r][0] + (s[0] - t.v[r][0]) * i, h = t.v[r][1] + (s[1] - t.v[r][1]) * i, m2 = t.o[r][0] + (s[0] - t.o[r][0]) * -i, _ = t.o[r][1] + (s[1] - t.o[r][1]) * -i, M = t.i[r][0] + (s[0] - t.i[r][0]) * -i, p = t.i[r][1] + (s[1] - t.i[r][1]) * -i, o.setTripleAt(u, h, m2, _, M, p, r);
      return o;
      ...
      if (o !== 0) {
        ...
        for (i = 0; i < s; i += 1) {
          if (u = this.shapes[i], h = u.localShapeCollection, !(!u.shape._mdf && !this._mdf && !t))
            for (h.releaseShapes(), u.shape._mdf = true, e = u.shape.paths.shapes, r = u.shape.paths._length, n = 0; n < r; n += 1)
          ...
          if (this._isDirty && (this.precalculateMatrix(), this._isDirty = false), this.iterateDynamicProperties(), this._mdf || h) {
            ...
            if (this.v.cloneFromProps(this.pre.props), this.appliedTransformations < 1 && this.v.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]), this.appliedTransformations < 2 && this.v.scale(this.s.v[0], this.s.v[1], this.s.v[2]), this.sk && this.appliedTransformations < 3 && this.v.skewFromAxis(-this.sk.v, this.sa.v), this.r && this.appliedTransformations < 4 ? this.v.rotate(-this.r.v) : !this.r && this.appliedTransformations < 4 && this.v.rotateZ(-this.rz.v).rotateY(this.ry.v).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(this.or.v[0]), this.autoOriented) {
              ...
              if (m2 = this.elem.globalData.frameRate, this.p && this.p.keyframes && this.p.getValueAtTime)
                this.p._caching.lastFrame + this.p.offsetTime <= this.p.keyframes[0].t ? (_ = this.p.getValueAtTime((this.p.keyframes[0].t + 0.01) / m2, 0), M = this.p.getValueAtTime(this.p.keyframes[0].t / m2, 0)) : this.p._caching.lastFrame + this.p.offsetTime >= this.p.keyframes[this.p.keyframes.length - 1].t ? (_ = this.p.getValueAtTime(this.p.keyframes[this.p.keyframes.length - 1].t / m2, 0), M = this.p.getValueAtTime((this.p.keyframes[this.p.keyframes.length - 1].t - 0.05) / m2, 0)) : (_ = this.p.pv, M = this.p.getValueAtTime((this.p._caching.lastFrame + this.p.offsetTime - 0.01) / m2, this.p.offsetTime));
      ...
      function o(h, m2, _) {
        if (this.elem = h, this.frameId = -1, this.propType = "transform", this.data = m2, this.v = new ot(), this.pre = new ot(), this.appliedTransformations = 0, this.initDynamicPropertyContainer(_ || h), m2.p && m2.p.s ? (this.px = V.getProp(h, m2.p.x, 0, 0, this), this.py = V.getProp(h, m2.p.y, 0, 0, this), m2.p.z && (this.pz = V.getProp(h, m2.p.z, 0, 0, this))) : this.p = V.getProp(h, m2.p || { k: [0, 0, 0] }, 1, 0, this), m2.rx) {
          if (this.rx = V.getProp(h, m2.rx, 0, J, this), this.ry = V.getProp(h, m2.ry, 0, J, this), this.rz = V.getProp(h, m2.rz, 0, J, this), m2.or.k[0].ti) {
            ...
            for (M = 0; M < p; M += 1)
              m2.or.k[M].to = null, m2.or.k[M].ti = null;
          }
          this.or = V.getProp(h, m2.or, 1, J, this), this.or.sh = true;
        } else
          this.r = V.getProp(h, m2.r || { k: 0 }, 0, J, this);
    ...
    X([gt], At), At.prototype.initModifierProperties = function(t, e) {
      ...
      if (this._mdf || t) {
        ...
        if (p > 0) {
          for (; d < P; )
            this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, false), d += 1;
          b && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, b, false), d += b);
        } else if (p < 0) {
          for (; d > P; )
            this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, true), d -= 1;
        ...
        for (var f, c; r; ) {
          if (e = this.elemsData[s].it, i = e[e.length - 1].transform.mProps.v.props, c = i.length, e[e.length - 1].transform.mProps._mdf = true, e[e.length - 1].transform.op._mdf = true, e[e.length - 1].transform.op.v = this._currentCopies === 1 ? this.so.v : this.so.v + (this.eo.v - this.so.v) * (s / (this._currentCopies - 1)), d !== 0) {
            ...
            for (this.matrix.reset(), f = 0; f < c; f += 1)
              i[f] = this.matrix.props[f];
          d += 1, r -= 1, s += n;
        }
      } else
    ...
    X([gt], ve), ve.prototype.initModifierProperties = function(t, e) {
      ...
      for (s = 0; s < n; s += 1)
        r = t.v[s], u = t.o[s], o = t.i[s], r[0] === u[0] && r[1] === u[1] && r[0] === o[0] && r[1] === o[1] ? (s === 0 || s === n - 1) && !t.c ? (i.setTripleAt(r[0], r[1], u[0], u[1], o[0], o[1], M), M += 1) : (s === 0 ? h = t.v[n - 1] : h = t.v[s - 1], m2 = Math.sqrt(Math.pow(r[0] - h[0], 2) + Math.pow(r[1] - h[1], 2)), _ = m2 ? Math.min(m2 / 2, e) / m2 : 0, C = r[0] + (h[0] - r[0]) * _, p = C, y = r[1] - (r[1] - h[1]) * _, b = y, P = p - (p - r[0]) * Rt, S = b - (b - r[1]) * Rt, i.setTripleAt(p, b, P, S, C, y, M), M += 1, s === n - 1 ? h = t.v[0] : h = t.v[s + 1], m2 = Math.sqrt(Math.pow(r[0] - h[0], 2) + Math.pow(r[1] - h[1], 2)), _ = m2 ? Math.min(m2 / 2, e) / m2 : 0, P = r[0] + (h[0] - r[0]) * _, p = P, S = r[1] + (h[1] - r[1]) * _, b = S, C = p - (p - r[0]) * Rt, y = b - (b - r[1]) * Rt, i.setTripleAt(p, b, P, S, C, y, M), M += 1) : (i.setTripleAt(t.v[s][0], t.v[s][1], t.o[s][0], t.o[s][1], t.i[s][0], t.i[s][1], M), M += 1);
      return i;
    ...
    U.prototype.point = function(t) {
      ...
      if (t <= 0)
        return [Di(this.points[0]), this];
      if (t >= 1)
        return [this, Di(this.points[this.points.length - 1])];
    ...
    function Wi(t, e) {
      ...
      for (var r = Us(3 * t.a[e], 2 * t.b[e], t.c[e]), o = 0; o < r.length; o += 1)
        if (r[o] > 0 && r[o] < 1) {
          var u = t.point(r[o])[e];
          u < i ? i = u : u > s && (s = u);
        }
    ...
    me.prototype.processPath = function(t, e, i, s) {
      ...
      Yi(r, t, 0, e, i, s, o);
      for (var h = 0; h < n; h += 1)
        o = tr(r, u, e, i, s, -o), h === n - 1 && !t.c ? u = null : u = U.shapeSegment(t, (h + 1) % n), Yi(r, t, h + 1, e, i, s, o);
      return r;
      ...
      if (o !== 0) {
        var m2, _;
        for (i = 0; i < s; i += 1) {
          if (m2 = this.shapes[i], _ = m2.localShapeCollection, !(!m2.shape._mdf && !this._mdf && !t))
            for (_.releaseShapes(), m2.shape._mdf = true, e = m2.shape.paths.shapes, r = m2.shape.paths._length, n = 0; n < r; n += 1)
              _.addShape(this.processPath(e[n], o, u, h));
    ...
    function er(t) {
      for (var e, i = 1; i < t.length; i += 1)
        e = Ki(t[i - 1], t[i]), t[i - 1] = e[0], t[i] = e[1];
    ...
    function Ui(t, e) {
      ...
      if (i.length === 1 || Be(i[1], 1))
        return r = t.split(i[0]), s = r[0], n = r[1], [se(s, e), se(n, e)];
      r = t.split(i[0]), s = r[0];
      var u = (i[1] - i[0]) / (1 - i[0]);
    ...
    X([gt], ge), ge.prototype.initModifierProperties = function(t, e) {
      ...
      var o, u, h, m2 = [];
      for (o = 0; o < r; o += 1)
        h = U.shapeSegment(t, o), m2.push(Ui(h, e));
      if (!t.c)
        for (o = r - 1; o >= 0; o -= 1)
          h = U.shapeSegmentInverted(t, o), m2.push(Ui(h, e));
      m2 = er(m2);
      var _ = null, M = null;
      for (o = 0; o < m2.length; o += 1) {
        var p = m2[o];
        for (M && (_ = Hi(n, M, p[0], i, s)), M = p[p.length - 1], u = 0; u < p.length; u += 1)
          h = p[u], _ && ie(h.points[0], _) ? n.setXYAt(h.points[1][0], h.points[1][1], "o", n.length() - 1) : n.setTripleAt(h.points[0][0], h.points[0][1], h.points[1][0], h.points[1][1], h.points[0][0], h.points[0][1], n.length()), n.setTripleAt(h.points[3][0], h.points[3][1], h.points[3][0], h.points[3][1], h.points[2][0], h.points[2][1], n.length()), _ = h.points[3];
      }
      ...
      if (o !== 0) {
        ...
        for (i = 0; i < s; i += 1) {
          if (m2 = this.shapes[i], _ = m2.localShapeCollection, !(!m2.shape._mdf && !this._mdf && !t))
            for (_.releaseShapes(), m2.shape._mdf = true, e = m2.shape.paths.shapes, r = m2.shape.paths._length, n = 0; n < r; n += 1)
              _.addShape(this.processPath(e[n], o, h, u));
          m2.shape.paths = m2.localShapeCollection;
        }
      }
      this.dynamicProperties.length || (this._mdf = false);
    ...
    var Kt = function() {
      ...
      function p(v) {
        ...
        for (a = 0; a < l; a += 1)
          k[a] !== "sans-serif" && k[a] !== "monospace" && E.push(k[a]);
        return E.join(",");
      }
      function b(v, k) {
        var a = Vt("span");
      ...
      function P() {
        ...
        for (v = 0; v < k; v += 1)
          this.fonts[v].loaded ? E -= 1 : this.fonts[v].fOrigin === "n" || this.fonts[v].origin === 0 ? this.fonts[v].loaded = true : (a = this.fonts[v].monoCase.node, l = this.fonts[v].monoCase.w, a.offsetWidth !== l ? (E -= 1, this.fonts[v].loaded = true) : (a = this.fonts[v].sansCase.node, l = this.fonts[v].sansCase.w, a.offsetWidth !== l && (E -= 1, this.fonts[v].loaded = true)), this.fonts[v].loaded && (this.fonts[v].sansCase.parent.parentNode.removeChild(this.fonts[v].sansCase.parent), this.fonts[v].monoCase.parent.parentNode.removeChild(this.fonts[v].monoCase.parent)));
      ...
      function C(v, k) {
        ...
        for (l = 0; l < E; l += 1) {
          var R = true, q, D;
          if (a[l].loaded = false, a[l].monoCase = b(a[l].fFamily, "monospace"), a[l].sansCase = b(a[l].fFamily, "sans-serif"), !a[l].fPath)
            a[l].loaded = true, w -= 1;
            ...
            for (q = document.querySelectorAll('link[f-forigin="g"], link[f-origin="1"]'), D = 0; D < q.length; D += 1)
              q[D].href.indexOf(a[l].fPath) !== -1 && (R = false);
            if (R) {
              var H = Vt("link");
      ...
      function y(v) {
        if (v) {
          ...
          for (k = 0; k < a; k += 1) {
            for (l = 0, w = false; l < E; )
              this.chars[l].style === v[k].style && this.chars[l].fFamily === v[k].fFamily && this.chars[l].ch === v[k].ch && (w = true), l += 1;
      ...
      function d(v, k, a) {
        for (var l = 0, E = this.chars.length; l < E; ) {
          if (this.chars[l].ch === v && this.chars[l].style === k && this.chars[l].fFamily === a)
            return this.chars[l];
          l += 1;
        }
    ...
    function $i(t, e) {
      ...
      var s, n = i.length, r;
      for (s = 0; s < n; s += 1)
        r = new ye(i[s], e), this.effectElements.push(r);
    }
    function ye(t, e) {
      this.init(t, e);
    }
    ...
    re.prototype = { initTransform: function() {
      ...
      var r, o = i.length, u;
      for (r = 0; r < o; r += 1)
        u = i[r].mat.applyToPointArray(0, 0, 0), e = [e[0] - u[0], e[1] - u[1], 0];
      return e;
    }, mHelper: new ot() };
    function Ut(t, e, i) {
      ...
      for (n = 0; n < r; n += 1)
        if ((u[n].mode !== "a" && u[n].mode !== "n" || u[n].inv || u[n].o.k !== 100 || u[n].o.x) && (y = "mask", d = "mask"), (u[n].mode === "s" || u[n].mode === "i") && h === 0 ? (b = W("rect"), b.setAttribute("fill", "#ffffff"), b.setAttribute("width", this.element.comp.data.w || 0), b.setAttribute("height", this.element.comp.data.h || 0), m2.push(b)) : b = null, o = W("path"), u[n].mode === "n")
          this.viewData[n] = { op: V.getProp(this.element, u[n].o, 0, 0.01, this.element), prop: Ve.getShapeProp(this.element, u[n], 3), elem: o, lastPath: "" }, s.appendChild(o);
        else {
      ...
      for (this.maskElement = W(y), r = m2.length, n = 0; n < r; n += 1)
        this.maskElement.appendChild(m2[n]);
    ...
    be.prototype = { initRendererElement: function() {
      ...
      if (this.data.ln && this.layerElement.setAttribute("id", this.data.ln), this.data.cl && this.layerElement.setAttribute("class", this.data.cl), this.data.ty === 0 && !this.data.hd) {
        ...
        if (s.setAttribute("id", r), s.appendChild(n), this.globalData.defs.appendChild(s), this.checkMasks()) {
          ...
          this.layerElement.setAttribute("clip-path", "url(" + dt() + "#" + r + ")");
      }
    ...
    function De(t, e, i, s) {
      ...
      for (n = 0; n < r; n += 1)
        o = V.getProp(t, e[n].v, 0, 0, this), this.k = o.k || this.k, this.dataProps[n] = { n: e[n].n, p: o };
    ...
    ae.prototype.initGradientData = function(t, e, i) {
      ...
      if (this.g._hasOpacity && !this.g._collapsable) {
        ...
        for (s = t.g.p * 4; s < n; s += 2)
          i = W("stop"), i.setAttribute("stop-color", "rgb(255,255,255)"), m2.appendChild(i), _.push(i);
    ...
    var ps = function(e, i, s, n) {
      ...
      for (h = 1; h < i; h += 1)
        m2 += " C" + n.applyToPointStringified(r[h - 1][0], r[h - 1][1]) + " " + n.applyToPointStringified(o[h][0], o[h][1]) + " " + n.applyToPointStringified(u[h][0], u[h][1]);
      ...
      function o(M, p, b) {
        ...
        for (f = 0; f < c; f += 1) {
          ...
          if (A = p.sh.paths, S = A._length, y) {
            for (C = "", P = 0; P < S; P += 1)
              d = A.shapes[P], d && d._length && (C += ps(d, d._length, d.c, T));
            p.caches[f] = C;
          } else
            C = p.caches[f];
      ...
      function m2(M, p, b) {
        ...
        if (M.t === 1)
          (p.e._mdf || b) && (P.setAttribute("x2", y[0]), P.setAttribute("y2", y[1]), S && !p.g._collapsable && (p.of.setAttribute("x2", y[0]), p.of.setAttribute("y2", y[1])));
        else {
          var N;
    ...
    X([Nt, re, be, is, ne, zt, Se], Q), Q.prototype.initSecondaryElement = function() {
      ...
      for (s = 0; s < n; s += 1) {
        for (r = this.stylesList[s], u = false, o.length = 0, t = 0; t < e; t += 1)
          i = this.shapes[t], i.styles.indexOf(r) !== -1 && (o.push(i), u = i._isAnimated || u);
      ...
      for (h = m2; h >= 0; h -= 1) {
        if (C = this.searchProcessedElement(t[h]), C ? e[h] = i[C - 1] : t[h]._render = o, t[h].ty === "fl" || t[h].ty === "st" || t[h].ty === "gf" || t[h].ty === "gs" || t[h].ty === "no")
          C ? e[h].style.closed = false : e[h] = this.createStyleElement(t[h], n), t[h]._render && e[h].style.pElem.parentNode !== s && s.appendChild(e[h].style.pElem), p.push(e[h].style);
        else if (t[h].ty === "gr") {
          if (!C)
      ...
      for (m2 = p.length, h = 0; h < m2; h += 1)
        p[h].closed = true;
      for (m2 = b.length, h = 0; h < m2; h += 1)
        b[h].closed = true;
    ...
    lt.prototype.defaultBoxWidth = [0, 0], lt.prototype.copyData = function(t, e) {
      ...
      for (var e = [], i = 0, s = t.length, n, r, o = false, u = false, h = ""; i < s; )
      ...
      if (t.sz)
        for (var x = true, I = t.sz[0], j = t.sz[1], N, L; x; ) {
          L = this.buildFinalText(t.t), N = 0, P = 0, r = L.length, A = t.tr / 1e3 * t.finalSize;
          var G = -1;
          for (n = 0; n < r; n += 1)
            T = L[n].charCodeAt(0), o = false, L[n] === " " ? G = n : (T === 13 || T === 3) && (P = 0, o = true, N += t.finalLineHeight || t.finalSize * 1.2), e.chars ? (f = e.getCharData(L[n], d.fStyle, d.fFamily), c = o ? 0 : f.w * t.finalSize / 100) : c = e.measureText(L[n], t.f, t.finalSize), P + c > I && L[n] !== " " ? (G === -1 ? r += 1 : n = G, N += t.finalLineHeight || t.finalSize * 1.2, L.splice(n, G === n ? 1 : 0, "\r"), G = -1, P = 0) : (P += c, P += A);
      ...
      if (t.l = s, S = P > S ? P : S, b.push(P), t.sz)
      ...
      var l, E, w = [];
      for (C = 0; C < y; C += 1) {
        for (k = v[C], k.a.sc && (t.strokeColorAnim = true), k.a.sw && (t.strokeWidthAnim = true), (k.a.fc || k.a.fh || k.a.fs || k.a.fb) && (t.fillColorAnim = true), E = 0, l = k.s.b, n = 0; n < r; n += 1)
          a = s[n], a.anIndexes[C] = E, (l == 1 && a.val !== "" || l == 2 && a.val !== "" && a.val !== " " || l == 3 && (a.n || a.val == " " || n == r - 1) || l == 4 && (a.n || n == r - 1)) && (k.s.rn === 1 && w.push(E), E += 1);
    ...
    var mr = function() {
      ...
      s.prototype = { getMult: function(o) {
        ...
        if (S === 2)
          P === b ? p = o >= P ? 1 : 0 : p = t(0, e(0.5 / (P - b) + (o - b) / (P - b), 1)), p = M(p);
        else if (S === 3)
          P === b ? p = o >= P ? 0 : 1 : p = 1 - t(0, e(0.5 / (P - b) + (o - b) / (P - b), 1)), p = M(p);
        else if (S === 4)
          P === b ? p = 0 : (p = t(0, e(0.5 / (P - b) + (o - b) / (P - b), 1)), p < 0.5 ? p *= 2 : p = 1 - 2 * (p - 0.5)), p = M(p);
        else if (S === 5) {
          if (P === b)
            p = 0;
          else {
          ...
          S === 6 ? (P === b ? p = 0 : (o = e(t(0, o + 0.5 - b), P - b), p = (1 + Math.cos(Math.PI + Math.PI * 2 * o / (P - b))) / 2), p = M(p)) : (o >= i(b) && (o - b < 0 ? p = t(0, e(e(P, 1) - (b - o), 1)) : p = t(0, e(P - o, 1))), p = M(p));
        if (this.sm.v !== 100) {
    ...
    Jt.prototype.searchProperties = function() {
      ...
      for (t = 0; t < e; t += 1)
        i = this._textData.a[t], this._animatorsData[t] = new gr(this._elem, i, this);
      ...
      if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
        ...
        if (this._hasMaskedPath) {
          ...
          if (b = this._pathData.pi, P = this._pathData.f.v, f = 0, d = 1, C = 0, y = true, A = b.segments, P < 0 && N.v.c)
            for (b.tLength < Math.abs(P) && (P = -Math.abs(P) % b.tLength), f = A.length - 1, g = A[f].points, d = g.length - 1; P < 0; )
              P += g[d].partialLength, d -= 1, d < 0 && (f -= 1, g = A[f].points, d = g.length - 1);
        ...
        if (t.j === 2 || t.j === 1) {
          ...
          for (_ = 0; _ < M; _ += 1)
            if (p[_].n) {
              ...
              for (a = 0; a < l; a += 1)
                v = s[a].a, v.t.propType && (Xt && t.j === 2 && (Wt += v.t.v * Gt), k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), w.length ? vt += v.t.v * w[0] * Gt : vt += v.t.v * w * Gt);
              Xt = false;
            }
          for (vt && (vt += Wt); bt < _; )
            p[bt].animatorJustifyOffset = vt, bt += 1;
        ...
        for (_ = 0; _ < M; _ += 1) {
          if (r.reset(), ct = 1, p[_].n)
            h = 0, m2 += t.yOffset, m2 += F ? 1 : 0, P = H, F = false, this._hasMaskedPath && (f = et, d = ut, g = A[f].points, c = g[d - 1], S = g[d], T = S.partialLength, C = 0), Ct = "", Ft = "", xt = "", Lt = "", It = this.defaultPropsArray;
          else {
            if (this._hasMaskedPath) {
              if (wt !== p[_].line) {
                switch (t.j) {
              ...
              var St = 0;
              for (a = 0; a < l; a += 1)
                v = s[a].a, v.p.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), w.length ? St += v.p.v[0] * w[0] : St += v.p.v[0] * w), v.a.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), w.length ? St += v.a.v[0] * w[0] : St += v.a.v[0] * w);
              for (y = true, this._pathData.a.v && (P = p[0].an * 0.5 + (x - this._pathData.f.v - p[0].an * 0.5 - p[p.length - 1].an * 0.5) * R / (M - 1), P += this._pathData.f.v); y; )
                C + T >= P + St || !g ? (I = (P + St - C) / S.partialLength, D = c.point[0] + (S.point[0] - c.point[0]) * I, Y = c.point[1] + (S.point[1] - c.point[1]) * I, r.translate(-i[0] * p[_].an * 5e-3, -(i[1] * O) * 0.01), y = false) : g && (C += S.partialLength, d += 1, d >= g.length && (d = 0, f += 1, A[f] ? g = A[f].points : N.v.c ? (d = 0, f = 0, g = A[f].points) : (C -= S.partialLength, g = null)), g && (c = S, S = g[d], T = S.partialLength));
              q = p[_].an / 2 - p[_].add, r.translate(-q, 0, 0);
            } else
              q = p[_].an / 2 - p[_].add, r.translate(-q, 0, 0), r.translate(-i[0] * p[_].an * 5e-3, -i[1] * O * 0.01, 0);
            for (a = 0; a < l; a += 1)
              v = s[a].a, v.t.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), (h !== 0 || t.j !== 0) && (this._hasMaskedPath ? w.length ? P += v.t.v * w[0] : P += v.t.v * w : w.length ? h += v.t.v * w[0] : h += v.t.v * w));
            for (t.strokeWidthAnim && (mt = t.sw || 0), t.strokeColorAnim && (t.sc ? nt = [t.sc[0], t.sc[1], t.sc[2]] : nt = [0, 0, 0]), t.fillColorAnim && t.fc && (K = [t.fc[0], t.fc[1], t.fc[2]]), a = 0; a < l; a += 1)
              v = s[a].a, v.a.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), w.length ? r.translate(-v.a.v[0] * w[0], -v.a.v[1] * w[1], v.a.v[2] * w[2]) : r.translate(-v.a.v[0] * w, -v.a.v[1] * w, v.a.v[2] * w));
            for (a = 0; a < l; a += 1)
              v = s[a].a, v.s.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), w.length ? r.scale(1 + (v.s.v[0] - 1) * w[0], 1 + (v.s.v[1] - 1) * w[1], 1) : r.scale(1 + (v.s.v[0] - 1) * w, 1 + (v.s.v[1] - 1) * w, 1));
            for (a = 0; a < l; a += 1) {
            ...
            for (a = 0; a < l; a += 1)
              v = s[a].a, v.p.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), this._hasMaskedPath ? w.length ? r.translate(0, v.p.v[1] * w[0], -v.p.v[2] * w[1]) : r.translate(0, v.p.v[1] * w, -v.p.v[2] * w) : w.length ? r.translate(v.p.v[0] * w[0], v.p.v[1] * w[1], -v.p.v[2] * w[2]) : r.translate(v.p.v[0] * w, v.p.v[1] * w, -v.p.v[2] * w));
    ...
    X([Nt, re, be, ne, zt, Se, yt], Mt), Mt.prototype.createContent = function() {
      ...
      if (M && !u && !i.sz) {
        ...
        for (e = d.length, b = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1)
          h = this.textSpans[t].span || W("tspan"), h.textContent = d[t], h.setAttribute("x", 0), h.setAttribute("y", b), h.style.display = "inherit", C.appendChild(h), this.textSpans[t] || (this.textSpans[t] = { span: null, glyph: null }), this.textSpans[t].span = h, b += i.finalLineHeight;
        ...
        for (t = 0; t < e; t += 1) {
          ...
          if (m2.reset(), M && (o[t].n && (p = -S, b += i.yOffset, b += P ? 1 : 0, P = false), this.applyTextPropertiesToMatrix(i, m2, o[t].line, p, b), p += o[t].l || 0, p += S), u) {
            ...
            var A;
            if (c.t === 1)
              A = new Ae(c.data, this.globalData, this);
            else {
              var T = yr;
            ...
            M && h.setAttribute("transform", "translate(" + m2.props[12] + "," + m2.props[13] + ")"), h.textContent = o[t].val, h.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve");
        }
...
@dotlottie/common/dist/lottie_light-KMJEUZFY.js:
  ...
  *)
*/
//# sourceMappingURL=lottie_light-KMJEUZFY-HEE4SZHY.js.map
